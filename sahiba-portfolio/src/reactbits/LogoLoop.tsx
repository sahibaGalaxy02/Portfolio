import type { CSSProperties, ReactNode, RefObject, DependencyList } from 'react';
type LogoItem = { href?: string; title?: string; ariaLabel?: string } & ({ node: ReactNode } | { src: string; srcSet?: string; sizes?: string; width?: number; height?: number; alt?: string });
type LogoLoopProps = { logos: LogoItem[]; speed?: number; direction?: 'left' | 'right' | 'up' | 'down'; width?: string | number; logoHeight?: number; gap?: number; pauseOnHover?: boolean; hoverSpeed?: number; fadeOut?: boolean; fadeOutColor?: string; scaleOnHover?: boolean; renderItem?: (item: LogoItem, key: string) => ReactNode; ariaLabel?: string; className?: string; style?: CSSProperties };
...
const useImageLoader = (seqRef: RefObject<HTMLUListElement | null>, onLoad: () => void, dependencies: DependencyList) => {
  useEffect(() => {
