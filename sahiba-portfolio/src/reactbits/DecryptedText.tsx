...
type DecryptedTextProps = HTMLMotionProps<'span'> & {
 text: string; speed?: number; maxIterations?: number; sequential?: boolean;
 revealDirection?: 'start' | 'end' | 'center'; useOriginalCharsOnly?: boolean; characters?: string;
 parentClassName?: string; encryptedClassName?: string; animateOn?: 'hover' | 'view' | 'inViewHover' | 'click'; clickMode?: 'once' | 'toggle';
};
